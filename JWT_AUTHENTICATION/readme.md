### ROutes used
/auth   => Only used for authentication
/       => After authentication

http://localhost:PORT/auth/forgotpassword
...
http://localhost:PORT/auth/registerpassword
## 1.1 Create Password
...
http://localhost:PORT/auth/resetpassword/:resetToken
## 3. resetPassword
